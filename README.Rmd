...
We'll want to augment the data, `d`, slightly by adding a numeric `day` index.
...
Happily, their distributions look reasonable. With the [psych package](https://cran.r-project.org/web/packages/psych/index.html), we can use the `describe()` function to get the typical descriptive statistics.
